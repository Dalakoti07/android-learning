...
import com.plcoding.bluetoothchat.domain.chat.BluetoothDataTransferService
...
import com.plcoding.bluetoothchat.domain.chat.toByteArray
        ...
        return flow {
            ...
            while (shouldLoop) {
                ...
                currentClientSocket?.let {
                    ...
                    emitAll(
                        service.listenForIncomingMessage()
                            .map {
